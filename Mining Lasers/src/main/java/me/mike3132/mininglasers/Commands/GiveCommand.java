            ...
            if (player.hasPermission("Laser.Give")) {
                ...
                if (args.length == 1) {
                    ...
                    if (args.length == 3) {
                        ...
                        //This is also where I am checking to see if the player has atleast 1 open slot.
                            ...
                            switch (args[3].toUpperCase()) {
                                case "SILK":
                                    if (args[2].equalsIgnoreCase("Diamond")) {
                                        ...
                                        if (player.getInventory().firstEmpty() != -1) {
                                            player.getInventory().addItem(DiamondSilk.laser);
                                            ...
                                            player.getLocation().getWorld().dropItem(player.getLocation().add(0, 1, 0), DiamondSilk.laser);
                                        }
                                    } else {
                                        if (args[2].equalsIgnoreCase("Netherite")) {
                                            player.sendMessage(Main.chatColor("" + this.plugin.getConfig().getString("Prefix") + "&9Enchantment &5Silk Touch &9Found. &6&lCreating your item now"));
                                            if (player.getInventory().firstEmpty() != -1) {
                                                player.getInventory().addItem(NetheriteSilk.laser);
                                                ...
                                                player.sendMessage(Main.chatColor("" + this.plugin.getConfig().getString("Prefix") + "&4&lError &cYour inventory is full, Your laser has been dropped on the ground"));
                                                player.getLocation().getWorld().dropItem(player.getLocation().add(0, 1, 0), NetheriteSilk.laser);
                                            }
                                        }
                                    }
                                    break;
                                case "FORTUNE":
                                    if (args[2].equalsIgnoreCase("Diamond")) {
                                        ...
                                        if (player.getInventory().firstEmpty() != -1) {
                                            player.getInventory().addItem(DiamondFortune.laser);
                                            ...
                                            player.sendMessage(Main.chatColor("" + this.plugin.getConfig().getString("Prefix") + "&4&lError &cYour inventory is full, Your laser has been dropped on the ground"));
                                            player.getLocation().getWorld().dropItem(player.getLocation().add(0, 1, 0), DiamondFortune.laser);
                                        }
                                    } else {
                                        if (args[2].equalsIgnoreCase("Netherite")) {
                                            player.sendMessage(Main.chatColor("" + this.plugin.getConfig().getString("Prefix") + "&9Enchantment &dFortune &9Found. &6&lCreating your item now"));
                                            if (player.getInventory().firstEmpty() != -1) {
                                                player.getInventory().addItem(NetheriteFortune.laser);
                                                ...
                                                player.sendMessage(Main.chatColor("" + this.plugin.getConfig().getString("Prefix") + "&4&lError &cYour inventory is full, Your laser has been dropped on the ground"));
                                                player.getLocation().getWorld().dropItem(player.getLocation().add(0, 1, 0), NetheriteFortune.laser);
                                            }
                                        }
                                    }
                                    break;
                ...
                //This is what is sent to the player if they don't have the permission to give themselves items.
                player.sendMessage(Main.chatColor("" + this.plugin.getConfig().getString("Prefix") + this.plugin.getConfig().getString("About")));
            }
        }
        return false;
    }
