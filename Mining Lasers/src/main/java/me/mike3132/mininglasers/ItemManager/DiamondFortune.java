...
public class DiamondFortune {
    ...
    private void createLaser() {
        ...
        for (String realLore : this.plugin.getConfig().getStringList("Diamond_Fortune_Lore")) {
            lore.add(Main.chatColor("" + realLore));
        }
        for (String enchants : this.plugin.getConfig().getStringList("Diamond_Fortune_Enchants")) {
        ...
        meta.setDisplayName(Main.chatColor("" + this.plugin.getConfig().getString("Diamond_Fortune_Name")));
        meta.setLore(lore);
